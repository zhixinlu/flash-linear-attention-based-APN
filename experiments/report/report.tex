...
the \textbf{APAN} (Associative Plasticity with Attractor Networks), the original Hebbian memory model using a pure attractor update;
...
The Associative Plasticity with Attractor Networks (APAN) is a biologically-inspired recurrent model that maintains a Hebbian plastic memory matrix $M_t$, updated at every time-step using the layer's full output as the learning signal.
...
\subsection{APAN Layer (Original: Associative Plasticity with Attractor Networks)}
\label{sec:apan}
