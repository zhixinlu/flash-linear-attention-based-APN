...
\begin{axis}[
    ...
    xlabel={\large Peak Test Accuracy (\%)},
    xmin=50, xmax=67.5,
    ymin=0, ymax=17,
    ...
    bar width=16pt,
    title={\Large\textbf{Peak Test Accuracy --- All Models}},
    every node near coord/.append style={font=\normalsize, anchor=west, xshift=1pt},
    nodes near coords={\pgfmathprintnumber[fixed, precision=1]{\pgfplotspointmeta}\%},
    point meta=x,
    xmajorgrids=true,
    grid style={gray!40, dashed},
    xtick={50,52,54,56,58,60,62,64,66},
]
\addplot[fill=gfr-k1, draw=black!50] coordinates {(53.57,1)};
\addplot[fill=gfr-k4, draw=black!50] coordinates {(56.00,2)};
\addplot[fill=apan-tanh, draw=black!50] coordinates {(56.42,3)};
\addplot[fill=apn-ffn, draw=black!50] coordinates {(56.84,4)};
\addplot[fill=gfr-ffn, draw=black!50] coordinates {(57.57,5)};
\addplot[fill=apan-rmsnorm!50, draw=black!50] coordinates {(57.89,6)};
\addplot[fill=apn-none, draw=black!50] coordinates {(58.34,7)};
\addplot[fill=gfr-ffn, draw=black!50] coordinates {(58.93,8)};
\addplot[fill=transformer-pm, draw=black!50] coordinates {(59.75,9)};
\addplot[fill=deltanet-pm, draw=black!50] coordinates {(60.06,10)};
\addplot[fill=deltanet-ffn, draw=black!50] coordinates {(62.80,11)};
\addplot[fill=deltanet, draw=black!50] coordinates {(62.28,12)};
\addplot[fill=transformer, draw=black!50] coordinates {(63.50,13)};
\addplot[fill=deltanet-ffn, draw=black!50] coordinates {(63.56,14)};
\addplot[fill=apan-rmsnorm, draw=black!50] coordinates {(64.22,15)};
\addplot[fill=transformer, draw=black!50] coordinates {(65.16,16)};
\end{axis}
\end{tikzpicture}
\caption{Summary of peak test accuracy across all models, sorted by performance. \textbf{APAN RMSNorm (105K params, purple)} achieves 64.2\%---outperforming models with $3$--$12\times$ more parameters and within 1 point of the full Transformer at 1.2M (65.2\%). Bar colors: purple = APAN, red = APN, teal = DeltaNet, blue = Transformer, brown/orange = GFR.}
