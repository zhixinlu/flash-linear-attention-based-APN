...
\addplot[fill=apan-rmsnorm] coordinates {(64.22,16)};
\addplot[fill=transformer] coordinates {(65.16,15)};
\addplot[fill=deltanet-ffn] coordinates {(63.56,14)};
\addplot[fill=transformer] coordinates {(63.50,13)};
\addplot[fill=deltanet] coordinates {(62.28,12)};
\addplot[fill=deltanet-ffn] coordinates {(62.80,11)};
\addplot[fill=deltanet-pm] coordinates {(60.06,10)};
\addplot[fill=transformer-pm] coordinates {(59.75,9)};
\addplot[fill=gfr-ffn] coordinates {(58.93,8)};
\addplot[fill=apn-none] coordinates {(58.34,7)};
\addplot[fill=apan-rmsnorm!60] coordinates {(57.89,6)};
\addplot[fill=gfr-ffn!60] coordinates {(57.57,5)};
\addplot[fill=apn-ffn] coordinates {(56.84,4)};
\addplot[fill=apan-tanh] coordinates {(56.42,3)};
\addplot[fill=gfr-k4] coordinates {(56.00,2)};
\addplot[fill=gfr-k1] coordinates {(53.57,1)};
\end{axis}
\end{tikzpicture}
\caption{Summary of peak test accuracy across all models. \textbf{APAN RMSNorm (105K params)} achieves 64.2\%, outperforming models with $3$--$12\times$ more parameters (DeltaNet 305K, GFR+FFN 1.2M, APN+FFN 1.2M) and coming within 1 point of the Transformer at 1.2M.}
