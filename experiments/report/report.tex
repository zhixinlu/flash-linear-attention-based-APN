...
\begin{axis}[
    ...
    yticklabels={
        ...
        {APN+FFN (1.2M)},
        {GFR+FFN D=34 (106K)},
        {APAN+FFN RMSNorm (907K)},
        {APN act=none (103K)},
        {GFR+FFN (1.2M)},
        {Transformer D=29 (103K)},
        {DeltaNet D=58 (104K)},
        {DeltaNet+FFN H=1 (1.2M)},
        {DeltaNet D=100 (305K)},
        {Transformer H=1 (1.2M)},
        {DeltaNet+FFN H=4 (1.2M)},
        {\textbf{APAN RMSNorm (105K)}},
        {Transformer H=4 (1.2M)}
    },
    ...
    title={\textbf{Summary: Peak Test Accuracy (All Models)}},
    title style={font=\large},
    nodes near coords,
    nodes near coords style={font=\footnotesize, anchor=west},
    every axis plot/.append style={fill opacity=0.9},
    legend style={at={(0.98,0.02)}, anchor=south east, font=\small, draw=none, fill=white, fill opacity=0.9},
]
% Single plot per color group for legend
\addplot[fill=apan-rmsnorm, draw=apan-rmsnorm!70!black] coordinates {(64.22,15)};
\addlegendentry{APAN}
\addplot[fill=apan-tanh, draw=apan-tanh!70!black] coordinates {(56.42,3)};
\addlegendentry{APAN (tanh/+FFN)}
\addplot[fill=apn-none, draw=apn-none!70!black] coordinates {(58.34,7)};
\addlegendentry{APN}
\addplot[fill=deltanet, draw=deltanet!70!black] coordinates {(60.06,10) (62.28,12)};
\addlegendentry{DeltaNet}
\addplot[fill=deltanet-ffn, draw=deltanet-ffn!70!black] coordinates {(62.80,11) (63.56,14)};
\addlegendentry{DeltaNet+FFN}
\addplot[fill=transformer, draw=transformer!70!black] coordinates {(63.50,13) (65.16,16)};
\addlegendentry{Transformer}
\addplot[fill=transformer-pm, draw=transformer-pm!70!black] coordinates {(59.75,9)};
\addlegendentry{Transformer (small)}
\addplot[fill=gfr-k1, draw=gfr-k1!70!black] coordinates {(53.57,1)};
\addlegendentry{GFR}
\addplot[fill=gfr-k4, draw=gfr-k4!70!black] coordinates {(56.00,2)};
\addplot[fill=gfr-ffn, draw=gfr-ffn!70!black] coordinates {(58.93,8) (57.57,5)};
\addplot[fill=apan-rmsnorm!50, draw=apan-rmsnorm!70!black] coordinates {(57.89,6)};
\addplot[fill=apn-ffn, draw=apn-ffn!70!black] coordinates {(56.84,4)};
\end{axis}
\end{tikzpicture}
\caption{Summary of peak test accuracy across all models, sorted by performance. \textbf{APAN RMSNorm (105K params)} achieves 64.2\%, outperforming models with $3$--$12\times$ more parameters (DeltaNet 305K: 62.3\%, GFR+FFN 1.2M: 58.9\%, APN+FFN 1.2M: 56.8\%) and within 1 point of the Transformer at 1.2M (65.2\%). Colors indicate model families.}
